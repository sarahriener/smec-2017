...
<div class="col-sm-3 hidden-xs">
    <div class="panel-group" id="accordion">
        ...
        <div class="panel panel-default">
            ...
            <a data-toggle="collapse" class="panelColor on" data-parent="#accordion" href="#{{ $category->dropdown_id }}">
                @else
                <a data-toggle="collapse" class="panelColor" data-parent="#accordion" href="#{{ $category->dropdown_id }}">
                    @endif

                    <div id="{{ $category->panel_heading_id }}" class="panel-heading">
                        <h4 class="panel-title">
                            <i class="fa {{ $category->icon }}" aria-hidden="true"></i>{{ $category->category_name }}
                        </h4>
                    </div>
                </a>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="{{ $categoryAttribute->url }}" class="selected">{{ $categoryAttribute->attribute_name }}</a>
                                        @else
                                        <a href="{{ $categoryAttribute->url }}">{{ $categoryAttribute->attribute_name }}</a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
