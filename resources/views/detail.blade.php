                ...
                <div>
                    <div class="menu__right">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="/google-shopping-compendium/attributes/image-link">Image</a>
                            </li>
                            <li class="active">Image Link</li>
                        </ol>
                        <div>
                            <h1>{{ $country->name }}
                            <!-- TODO wenn Country Img drinnen darauf zugreifen  && Flage hinzufügen-->
                                <a class="compareBtn" href="/compare/{{ $country->id }}" target="_self"
                                   class="btn btn-default subs-btn">Compare</a>
                            </h1>

                            <!-- TODO klasse eindeutig benennen!!!! -->
                            <p class="text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
                                ...
                                aliquyam erat, sed diam voluptua. At vero eos et accusam </p>
                        ...
                        <br/>
                        <div id="chartContainer3" class="cahart"></div>
