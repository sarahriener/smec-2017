...
@section('content')
    ...
    <div class="detail">
        ...
        <div class="menu__left">
            <div>
                <a class="menu" href="#" class="w3-bar-item w3-button"><span class="text">Overview</span></a>
                <a class="menu" href="#" class="w3-bar-item w3-button"><span class="text">Internet Useres</span></a>
                <a class="menu" href="#" class="w3-bar-item w3-button"><span class="text">E-Commerce</span></a>
                <a class="menu" href="#" class="w3-bar-item w3-button"><span class="text">Sales</span></a>
                <a class="menu" href="#" class="w3-bar-item w3-button"><span class="text">Ad Spend</span></a>
                <a class="menu" href="#" class="w3-bar-item w3-button"><span class="text">Ausgaben</span></a>
            </div>
        </div>

        <div class="country">
            <div>
                <div clas="country-header">
